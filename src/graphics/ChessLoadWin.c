...
int isClickOnSlot(int x, int y) {
 ...
 LoadWin*  loadWindowCreate() {
	...
	res->numSlotsShown = 0;//TODO need to be changed according to the num of saves that's alrdy happened
	res->chosenSlot = 0;
	...
	res->slot1Texture = SDL_CreateTextureFromSurface(res->LoadRenderer, loadingSurface);
	...
	res->slot2Texture = SDL_CreateTextureFromSurface(res->LoadRenderer, loadingSurface);
	...
	res->slot3Texture = SDL_CreateTextureFromSurface(res->LoadRenderer, loadingSurface);
	...
	res->slot4Texture = SDL_CreateTextureFromSurface(res->LoadRenderer, loadingSurface);
	...
	res->slot5Texture = SDL_CreateTextureFromSurface(res->LoadRenderer, loadingSurface);
